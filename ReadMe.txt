I changed Drink class and some of its methods to abstract so subclass can override it easily (for example Expresso class can have a new property called HasMocha and calculate the cost with Mocha cost).

Unit tests mainly check whether the drink cost is correct with different settings (e.g. milk, sugar, mocha)

I tried to use Factory pattern but found it's uncessary as inheritance works well enough.   
